...
import com.yantra.wms.agent.server.WMSTaskQueueAgentForWave;
...
public abstract class AbstractCustomTaskAgentForWave extends WMSTaskQueueAgentForWave implements ServiceAccess {

  private static YFCLogCategory logger = YFCLogCategory.instance(AbstractCustomTaskAgentForWave.class);
  ...
  public void executeTask(YFSEnvironment env, Document inXml) {
    ...
    try {
      ...
      executeTask(XMLUtil.getYFCDocument(inXml));
