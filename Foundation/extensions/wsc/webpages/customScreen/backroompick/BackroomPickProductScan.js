scDefine(["scbase/loader!dojo/_base/declare", "scbase/loader!ias/utils/BaseTemplateUtils", "scbase/loader!ias/utils/ContextUtils", "scbase/loader!ias/utils/EventUtils", "scbase/loader!ias/utils/RepeatingScreenUtils", "scbase/loader!ias/utils/ScreenUtils", "scbase/loader!ias/utils/UIUtils", "scbase/loader!ias/utils/WizardUtils", "scbase/loader!sc/plat/dojo/utils/BaseUtils", "scbase/loader!sc/plat/dojo/utils/EventUtils", "scbase/loader!sc/plat/dojo/utils/ModelUtils", "scbase/loader!sc/plat/dojo/utils/RepeatingPanelUtils", "scbase/loader!sc/plat/dojo/utils/ScreenUtils", "scbase/loader!sc/plat/dojo/utils/WidgetUtils", "scbase/loader!sc/plat/dojo/utils/WizardUtils", "scbase/loader!wsc/components/common/utils/CommonUtils", "scbase/loader!extn/customScreen/backroompick/BackroomPickProductScanUI", "scbase/loader!wsc/components/shipment/backroompick/utils/BackroomPickUpUtils", "scbase/loader!wsc/components/shipment/common/utils/ShipmentUtils"], function (
    ...
    return _dojodeclare("extn.customScreen.backroompick.BackroomPickProductScan", [_extnBackroomPickProductScanUI], {
        ...
        testRelationship: function () {
            ...
            var changeShipmentInput = {
                Shipment: {
                    ...
                    TransactionId: "READY_FOR_GIFT_WRAP.0001.ex"
                }
            };
        ...
        saveSucces: function (
            ...
            if (
                _extnBackroomPickUpUtils.isLastMashupRefId(
                    mashupRefId, mashupContext)) {
                this.gotoNextScreen();
            }
        },
        ...
        updateProductQuantity: function (
            ...
            if (!(
                ...
                _extnBackroomPickUpUtils.setPickedQuantityInScreen(
        ...
        getShipmentLinesRepeatingScreenData: function (
            ...
            var repeatingScreenId = "extn.customScreen.Line.ShipmentLineDetails";
        ...
        allItems_beforeHide: function (
            ...
            if (
                _iasRepeatingScreenUtils.isRepeatingScreenDirty(
                    this, "readyForPickupLineList", "extn.customScreen.Line.ShipmentLineDetails")) {
                _scScreenUtils.showConfirmMessageBox(
                    this, _scScreenUtils.getString(
        ...
        shortItems_beforeHide: function (
            ...
            if (
                _iasRepeatingScreenUtils.isRepeatingScreenDirty(
                    this, "unpickedLineList", "extn.customScreen.Line.ShipmentLineDetails")) {
                _scScreenUtils.showConfirmMessageBox(
                    this, _scScreenUtils.getString(
