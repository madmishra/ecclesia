...
public class IndgGetOrderDetails extends AbstractCustomApi{
	private static final String EMPTY_STRING = "";
	 ...
	 private YFCDocument getShipmentDetailsTemplate() {
		 ...
		 eleAdditionalDates.createChild(XMLLiterals.ADDITIONAL_DATE);
	 ...
	 private YFCDocument getOrderDetailsTemplate() {
		 ...
		 eleOrder.setAttribute(XMLLiterals.MIN_ORDER_STATUS_DESC, EMPTY_STRING);
		 ...
		 elePersonInfoBillTo.setAttribute(XMLLiterals.CITY, EMPTY_STRING);
	 ...
	 {
		YFCDocument docGetOrderDetailsOutput= invokeYantraApi(XMLLiterals.GET_COMPLETE_ORDER_DETAILS,inputGetOrderDetails(sDocumentType,sEnterpriseCode,sOrderNo),getOrderDetailsTemplate());
