...
import com.bridge.sterling.framework.agent.AbstractCustomTaskAgent;
...
public class CustomTaskAgent extends AbstractCustomTaskAgent {
  private static YFCLogCategory logger = YFCLogCategory.instance(CustomTaskAgent.class);
