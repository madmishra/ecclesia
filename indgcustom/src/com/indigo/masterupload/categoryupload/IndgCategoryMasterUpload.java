...
public class IndgCategoryMasterUpload extends AbstractCustomApi {
  ...
  public YFCDocument invoke(YFCDocument inXml) {
	  ...
	  if(!XmlUtils.isVoid(categoryInEle)) {
		  ...
		  YFCDocument categoryItemList = getCategoryList(categoryInEle.getAttribute(XMLLiterals.CATEGORY_ID),organizationCode,EMPTY_STRING);
		  manageDeleteCategory(categoryInEle.getAttribute(XMLLiterals.CATEGORY_ID),categoryInEle.getAttribute(XMLLiterals.CATEGORY_PATH),categoryItemList);
		  manageSubCategory(categoryInEle.getAttribute(XMLLiterals.CATEGORY_PATH),categoryInEle.getAttribute(XMLLiterals.CATEGORY_DOMAIN));
		  invokeYantraApi(XMLLiterals.MANAGE_CATEGORY, inXml);
  ...
  public static YFCDocument getInputXmlForGetCategoryList(String categoryId,String org,String categoryPath) {
	  ...
	  getCategoryListDoc.getDocumentElement().setAttribute(XMLLiterals.GET_UN_PUBLISHED_CATEGORY, FLAG_YES);
  ...
  */
  ...
  public YFCDocument getCategoryList(String categoryId, String org,String categoryPath) {
	  return invokeYantraApi(XMLLiterals.GET_CATEGORY_LIST, getInputXmlForGetCategoryList(categoryId,org,categoryPath),formTemplateXmlForgetCategoryList());
  }
  ...
  public static YFCDocument getInputXmlForCreateCategory(String categoryId,String categoryDomain,String path,String organizationCode) {
  ...
  public void createCategory(String categoryId,String categoryDomain,String path,String orgCode) {
    invokeYantraApi(XMLLiterals.CREATE_CATEGORY, getInputXmlForCreateCategory(categoryId,categoryDomain,path,orgCode));
  }
  ...
  private YFCDocument getItemList(String categoryPath) {
	  ...
	  return invokeYantraApi(XMLLiterals.GET_ITEM_LIST_API,itemInXml,IndgManageItemFeed.getTemplateForGetItemList());
  }
  ...
  public void manageDeleteCategory(String categoryId,String categoryPath,YFCDocument categoryListApiOp) {
	  YFCElement categoryEle = XPathUtil.getXPathElement(categoryListApiOp,"/CategoryList/Category[@CategoryID=\""+categoryId+"\"]");
  ...
  private boolean isDepartmentExist(String categoryId) {
	  ...
	  orgDoc.getDocumentElement().createChild(XMLLiterals.DEPARTMENT_LIST).createChild(XMLLiterals.DEPARTMENT).setAttribute(XMLLiterals.DEPARTMENT_NAME, categoryId);
