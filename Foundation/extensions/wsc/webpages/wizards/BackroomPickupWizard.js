scDefine(["scbase/loader!dojo/_base/declare", "scbase/loader!ias/utils/UIUtils", "scbase/loader!ias/utils/WizardUtils", "scbase/loader!sc/plat/dojo/utils/BaseUtils", "scbase/loader!sc/plat/dojo/utils/ModelUtils", "scbase/loader!sc/plat/dojo/utils/ResourcePermissionUtils", "scbase/loader!sc/plat/dojo/utils/ScreenUtils", "scbase/loader!sc/plat/dojo/utils/WidgetUtils", "scbase/loader!sc/plat/dojo/utils/WizardUtils", "scbase/loader!wsc/components/common/utils/CommonUtils", "scbase/loader!extn/wizards/BackroomPickupWizardUI" , "scbase/loader!sc/plat/dojo/utils/EventUtils"], function(
_dojodeclare, _iasUIUtils, _iasWizardUtils, _scBaseUtils, _scModelUtils, _scResourcePermissionUtils, _scScreenUtils, _scWidgetUtils, _scWizardUtils, _wscCommonUtils, _extnBackroomPickupWizardUI,_scEventUtils) {
    return _dojodeclare("extn.wizards.BackroomPickupWizard", [_extnBackroomPickupWizardUI], {
        // custom code here
        setWizardTitle: function(
        event, bEvent, ctrl, args) {
            var titleKey = "Title_GiftWrap";
            var titleDesc = null;
        ...
        changeConfirmButtonLiteralIfLastPage: function(
            ...
            if(_scWizardUtils.isCurrentPageLastEntity(this)) {
                 ...
                 this, "confirmBttn", _scScreenUtils.getString(this, "Label_GiftWrap_Complete"));
            }
        },
        ...
        handleConfirm : function(
            event, bEvent, ctrl, args){
                _scEventUtils.fireEventToChild(this , "extn_backroomPickProdutScan" ,"testRelationship" , null )
        }
    });
});