...
public class IndgManageCatgoryLoad extends AbstractCustomApi {
   ...
   */
   ...
   public YFCDocument getCategoryList(String categoryId, String org) {
	   return invokeYantraApi(XMLLiterals.GET_CATEGORY_LIST, IndgCategoryMasterUpload.getInputXmlForGetCategoryList
			   (categoryId,org,EMPTY_STRING), IndgCategoryMasterUpload.formTemplateXmlForgetCategoryList());
   }
    ...
    */
	...
	/**
	 * This method drops the department document in the queue for department mapping.
	 * @param doc
	 */
	
	private void callDeptMappingQueue(YFCDocument doc) {
		if(FLAG_YES.equals(getProperty(IS_DEPT_MAPPING_REQ)))
