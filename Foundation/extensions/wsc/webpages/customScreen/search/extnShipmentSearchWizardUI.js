...
templateText, _dijitButton, _dojodeclare, _dojokernel, _dojolang, _dojotext, _iasIASBaseWizard, _idxContentPane, _scplat, _scButtonDataBinder, _scBaseUtils) {
    return _dojodeclare("extn.customScreen.search.extnShipmentSearchWizardUI", [_iasIASBaseWizard], {
        templateString: templateText,
        uId: "extnShipmentSearchWizard",
        packageName: "extn.customScreen.search",
        className: "extnShipmentSearchWizard",
        title: "Gift Wrap",
        screen_description: "Shipment Search Wizard",
        wizardCompletionEditor: '',
