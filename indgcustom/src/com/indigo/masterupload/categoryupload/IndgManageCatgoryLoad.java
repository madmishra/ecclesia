...
public class IndgManageCatgoryLoad extends AbstractCustomApi {
   ...
   */
   ...
   /**
    * This methods forms the header of the document.
    * @param inXml
    */
   ...
   /**
    * This message for the input document for the department mapping
    * from the input XML for categoryFeed.
    * @param len
    * @param departmentDoc
    * @param categoryPath
    */
   ...
   /**
    * This method drops the departmentMsg into the queue.
    * @param doc
    */
