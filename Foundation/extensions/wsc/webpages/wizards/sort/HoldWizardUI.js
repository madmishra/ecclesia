...
templateText, _dijitButton, _dojodeclare, _dojokernel, _dojolang, _dojotext, _iasIASBaseWizard, _idxContentPane, _scplat, _scButtonDataBinder, _scCurrencyDataBinder, _scImageDataBinder, _scBaseUtils, _scDataLabel, _scImage) {
    return _dojodeclare("extn.wizards.sort.HoldWizardUI", [_iasIASBaseWizard], {
        templateString: templateText,
        uId: "SortScanPick",
        packageName: "extn.wizards.sort",
        className: "HoldWizard",
        title: "Title_Hold",
        screen_description: "Hold Wizard",
       ...
       showRelatedTaskInWizard: false,
        ...
        flowImage: 'wsc/resources/css/icons/images/backroomPickUp.png',
